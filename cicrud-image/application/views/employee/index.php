  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<form id="myForm" action="<?php base_url('addEmployee'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        		...
        		<div class="form-group">
        			<label for="number" class="label-control col-md-4">Number</label>
        			<div class="col-md-8">
            ...
            <div class="form-group">
        		<label for="file" class="label-control col-md-4">Upload Image</label>
		...
		$('#showdata').on('click', '.item-edit', function(){
			...
			$.ajax({
				...
				success: function(data){
					...
					$('input[name=txtNumber]').val(data.number);
					//$('input[name=txtImage]').val(data.file_name);
